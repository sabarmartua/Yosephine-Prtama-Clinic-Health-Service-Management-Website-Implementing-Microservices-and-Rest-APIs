            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-8">
                        ...
                        <form id="registration-form" action="{{ route('antrian.store') }}" method="POST">
                            @csrf
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="kepentingan">Kepentingan</label><br>
                                        <select id="kepentingan" name="kepentingan" class="form-control" required>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="deskripsi">Keluhan singkat</label>
                        ...
                        <div id="antrian-number" style="display: none;">
                            <h3>Your Queue Number: <span id="queue-number"></span></h3>
                        </div>
                    </div>
                </div>
            </div>
