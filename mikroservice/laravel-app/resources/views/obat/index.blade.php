    ...
    <section class="registration-form section-padding">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div>
                        <a href="{{ route('obat.create') }}" style="color: black;">Tambah Obat Baru</a>
                        @if(session('error'))
                        ...
                        @else
                            <table border="1">
                                ...
                                @else
                                    <tr>
                                        <td colspan="5">Tidak ada data obat yang tersedia saat ini. Mohon coba lagi nanti atau hubungi administrator.</td>
                                    </tr>
                                @endif
                            </table>
                        @endif
